...
// 		await testDiagnostics(getDocUri('diagnostics/timestamp_1.ion'), [
...
// 		await testDiagnostics(getDocUri('diagnostics/timestamp_2.ion'), [
...
// 		await testDiagnostics(getDocUri('diagnostics/timestamp_3.ion'), [
...
// 		await testDiagnostics(getDocUri('diagnostics/timestamp_4.ion'), [
...
// 		await testDiagnostics(getDocUri('diagnostics/timestamp_5.ion'), [
...
// 		await testDiagnostics(getDocUri('diagnostics/timestamp_6.ion'), [
// 			{ message: 'no viable alternative at input \'2007:\'', range: toRange(0, 4, 0, 5), severity: vscode.DiagnosticSeverity.Warning, source: 'ex' }
// 		]);
// 	});
// 	test('timestamp: Missing minute', async () => {
// 		await testDiagnostics(getDocUri('diagnostics/timestamp_7.ion'), [
...
// 		await testDiagnostics(getDocUri('diagnostics/timestamp_8.ion'), [
// 			{ message: 'no viable alternative at input \'2004-12-11T12\'', range: toRange(0, 11, 0, 13), severity: vscode.DiagnosticSeverity.Warning, source: 'ex' }
// 		]);
// 	});
// 	test('timestamp: Invalid local offset 2', async () => {
// 		await testDiagnostics(getDocUri('diagnostics/timestamp_9.ion'), [
// 			{ message: 'no viable alternative at input \'2004-12-11T12\'', range: toRange(0, 11, 0, 13), severity: vscode.DiagnosticSeverity.Warning, source: 'ex' }
// 		]);
// 	});
// 	test('timestamp: Invalid second', async () => {
// 		await testDiagnostics(getDocUri('diagnostics/timestamp_10.ion'), [
// 			{ message: 'no viable alternative at input \'2004-12-11T12\'', range: toRange(0, 11, 0, 13), severity: vscode.DiagnosticSeverity.Warning, source: 'ex' }
// 		]);
// 	});
// 	test('blob: Invalid content 1', async () => {
// 		await testDiagnostics(getDocUri('diagnostics/blob_1.ion'), [
...
// 		await testDiagnostics(getDocUri('diagnostics/blob_2.ion'), [
// 			{ message: 'no viable alternative at input \'{{\'', range: toRange(0, 1, 0, 2), severity: vscode.DiagnosticSeverity.Warning, source: 'ex' }
// 		]);
// 	});
// 	test('clob: 2 double colons strings', async () => {
// 		await testDiagnostics(getDocUri('diagnostics/clob_1.ion'), [
// 			{ message: 'no viable alternative at input \'{{\'', range: toRange(0, 1, 0, 2), severity: vscode.DiagnosticSeverity.Warning, source: 'ex' }
// 		]);
// 	});
// 	test('clob: Single colon string', async () => {
// 		await testDiagnostics(getDocUri('diagnostics/clob_2.ion'), [
// 			{ message: 'no viable alternative at input \'{{\'', range: toRange(0, 1, 0, 2), severity: vscode.DiagnosticSeverity.Warning, source: 'ex' }
// 		]);
// 	});
// 	test('clob: Added comment', async () => {
// 		await testDiagnostics(getDocUri('diagnostics/clob_3.ion'), [
// 			{ message: 'no viable alternative at input \'{{\'', range: toRange(0, 1, 0, 2), severity: vscode.DiagnosticSeverity.Warning, source: 'ex' }
// 		]);
// 	});
// 	test('number: Used minus sign', async () => {
// 		await testDiagnostics(getDocUri('diagnostics/number_1.ion'), [
...
// 		await testDiagnostics(getDocUri('diagnostics/number_2.ion'), [
...
// 		await testDiagnostics(getDocUri('diagnostics/number_3.ion'), [
...
// 		await testDiagnostics(getDocUri('diagnostics/number_4.ion'), [
...
// 		await testDiagnostics(getDocUri('diagnostics/number_5.ion'), [
...
// 		await testDiagnostics(getDocUri('diagnostics/number_6.ion'), [
...
// 		await testDiagnostics(getDocUri('diagnostics/number_7.ion'), [
...
// 		await testDiagnostics(getDocUri('diagnostics/number_8.ion'), [
...
// 		await testDiagnostics(getDocUri('diagnostics/number_9.ion'), [
...
// 		await testDiagnostics(getDocUri('diagnostics/number_10.ion'), [
...
// 		await testDiagnostics(getDocUri('diagnostics/number_11.ion'), [
...
// 		await testDiagnostics(getDocUri('diagnostics/number_12.ion'), [
...
// 		await testDiagnostics(getDocUri('diagnostics/list_1.ion'), [
...
// 		await testDiagnostics(getDocUri('diagnostics/list_2.ion'), [
// 			{ message: 'no viable alternative at input \'[)\'', range: toRange(0, 1, 0, 2), severity: vscode.DiagnosticSeverity.Warning, source: 'ex' }
// 		]);
// 	});
// 	test('list: Missing close parenthesis', async () => {
// 		await testDiagnostics(getDocUri('diagnostics/list_3.ion'), [
...
// 		await testDiagnostics(getDocUri('diagnostics/null_1.ion'), [
...
// 		await testDiagnostics(getDocUri('diagnostics/null_2.ion'), [
...
// 		await testDiagnostics(getDocUri('diagnostics/sexp_1.ion'), [
...
// 		await testDiagnostics(getDocUri('diagnostics/sexp_2.ion'), [
// 			{ message: 'no viable alternative at input \'(]\'', range: toRange(0, 1, 0, 2), severity: vscode.DiagnosticSeverity.Warning, source: 'ex' }
// 		]);
// 	});
// 	test('struct: Added annotation before field name', async () => {
// 		await testDiagnostics(getDocUri('diagnostics/struct_1.ion'), [
...
// 		await testDiagnostics(getDocUri('diagnostics/struct_2.ion'), [
// 			{ message: 'no viable alternative at input \'{]\'', range: toRange(0, 1, 0, 2), severity: vscode.DiagnosticSeverity.Warning, source: 'ex' }
// 		]);
// 	});
// 	test('struct: Invalid comma', async () => {
// 		await testDiagnostics(getDocUri('diagnostics/struct_3.ion'), [
...
// 		await testDiagnostics(getDocUri('diagnostics/struct_4.ion'), [
// 			{ message: 'no viable alternative at input \'{a:b\\n\'', range: toRange(1, 0, 1, 0), severity: vscode.DiagnosticSeverity.Warning, source: 'ex' }
// 		]);
// 	});
// 	test('struct: Missing colon', async () => {
// 		await testDiagnostics(getDocUri('diagnostics/struct_5.ion'), [
...
// 		await testDiagnostics(getDocUri('diagnostics/struct_6.ion'), [
...
// 		await testDiagnostics(getDocUri('diagnostics/symbol_1.ion'), [
...
// 		await testDiagnostics(getDocUri('diagnostics/annotation_1.ion'), [
...
// 		await testDiagnostics(getDocUri('diagnostics/annotation_2.ion'), [
...
// 		await testDiagnostics(getDocUri('diagnostics/annotation_3.ion'), [
